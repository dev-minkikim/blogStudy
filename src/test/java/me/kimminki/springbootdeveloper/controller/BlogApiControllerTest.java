package me.kimminki.springbootdeveloper.controller;
...
class BlogApiControllerTest {
    ...
    public void findAllArticles() throws Exception{
        ...
        //then
        //응답코드가 200 ok이고 반환받은 값 중에 0번째 요소의 content와 title이 저장된 값과 같은지 확인
        resultActions
    ...
    public void findArticle() throws Exception{
        ...
        //then
        //응답코드가 200 ok이고 반환받은 content와 title이 저장된 값과 같은지 확인한다.
        resultActions
                .andExpect(status().isOk())
